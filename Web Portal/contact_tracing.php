...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
  ...
  <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="band">
    ...
    <br>
  	<form method="post" action="contact_tracing_2.php">
      <div class="w3-row-padding" style="margin:0 -16px 8px -16px">
              ...
              <div class="w3-half">
                <!-- <input class="w3-input w3-border" type="text" placeholder="Registration number of institute" required name="Reg"> -->
                <select class="w3-input w3-border" required name="nic">
                  <?php
                  ...
                  $collection = $firestoreClient->listDocuments('institutes');
                  foreach($collection as $institutes) {
                    foreach($institutes as $ins) {
                      $infCollection = $firestoreClient->listDocuments(substr($ins->getRelativeName(), 1).'/infected');
                      foreach($infCollection as $infecteds) {
                        foreach($infecteds as $inf) {
                          $nic = $inf->get('nic');
              ...
              <br>
              <div class="w3-half">
                <label class="w3-input-no-border w3-hide-large w3-hide-medium" style="text-align: left;">Date : </label>
                <label class="w3-input-no-border w3-hide-small" style="text-align: right;">Date : </label>
              </div>
              <div class="w3-half">
                <input class="w3-input w3-border" type="text" placeholder="yyyy/MM/dd" required name="date">
              </div>
              ...
              <div class="w3-half">
               <button class="w3-button w3-black w3-section" style="padding-left: 30pt; padding-right: 30pt; float: left;" type="submit">Next</button>
              </div>
